...
/**
 * Execution state of an arithmetic goal. If an arithmetic AR has not been
 * visited, it is not fulfilled. If an arithmetic AR has been visited, but an
 * error occurred during evaluation of the rhs, it is not fulfilled. If an
 * arithmetic AR has been visited, but unification was unsuccessful, it is not
 * fulfilled. If an unification record has been visited and unification was
 * successful, it is fulfilled.
 */
public class ArithmeticActivationRecord extends ActivationRecord {
     ...
     */
    public ArithmeticActivationRecord(ArithmeticGoal goal, Interpreter interpreter,
    ...
    /**
     * Getter-method for the left hand side of the unification with all previous
    ...
    /**
     * Getter-method for the right hand side before evaluation with all previous
     * substitutions applied.
     *
    ...
    /**
     * Getter-method for the arithmetically evaluated right hand side. This may
     * return null if getResult().isError() == true
     *
     * @return evaluated right hand side, i.e. the actual right hand side of the
     *         unification
     */
