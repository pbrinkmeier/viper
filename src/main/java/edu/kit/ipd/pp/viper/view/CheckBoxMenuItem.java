...
public class CheckBoxMenuItem extends JCheckBoxMenuItem implements ActionListener, Observer {
    ...
    /**
     * Creates a new checkable menu item, that can either be used for a enable/disable item (e.g. enable/disable
     * standard library) or as a "radio selection" using a {@link ButtonGroup} (e.g. language selection).
     * 
