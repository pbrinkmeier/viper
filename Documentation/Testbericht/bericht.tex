...
\begin{itemize}
  ...
  \item \textbf{Rückgabewert \texttt{null} statt \texttt{Optional}}\\
        In der \texttt{ActivationRecord\#getPrevious()} Methode wurde in der letzten Zeile \texttt{null} statt einem \texttt{Optional<ActivationRecord>} zurückgegeben. Diese Zeile konnte nie erreicht werden, wurde aber vom Compiler gefordert. Die Methode wurde als Reaktion auf die Warnung von FindBugs umstrukturiert und neu implementiert.
\end{itemize}
