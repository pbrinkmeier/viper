...
\begin{enumerate}[label=\#\arabic*]
  \item \textbf{Hier steht die kurze Beschreibung des Fehlers}\\
        Hier steht eine ausführlichere Beschreibung. Warum tritt der Fehler auf?\\\\
        \textbf{Symptome:} Was genau sieht man?\\
...
\begin{itemize}
  ...
  \item \textbf{Zoom an der Position des Mauszeigers}\\
        Wird in der Visualisierung mittels des Mausrads der angezeigte Graph vergrößert oder verkleinert, so wird die Richtung des Zooms über die Position des Mauszeigers über dem Graphen bestimmt. Bisher wurde in der Visualisierung zentral herein- bzw. herausgezoomt.
