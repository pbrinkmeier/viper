...
\teststep{Das \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} ist im Editor-Fenster eingegeben und erfolgreich geparst worden. Das Eingabefeld ist freigegeben.}
...
\teststep{Das \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} ist im Editor-Fenster eingegeben worden.}
...
\teststep{Der Nutzer hat das unformatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} im Editor eingegeben oder aus einer Datei geöffnet.}
...
\teststep{Das \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} ist im Editor eingegeben und der unten gezeigte Zustand wurde erreicht und visualisiert.}
...
\teststep{Das \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} ist im Editor eingegeben und durch den Parser verarbeitet worden. Der Nutzer hat die Abfrage \texttt{father(homer, X)} eingegeben. Die Interpretation wird gestartet und die Visualisierung des ersten Interpretationsschritts wird angezeigt.}
...
\teststep{Das unformatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} ist im Editor eingetragen.}
...
\teststep{Das formatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} ist im Editor eingetragen.}
{Der Nutzer wählt über die Menüleiste die Speichern-Funktion aus.}
...
\teststep{Das formatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} ist im Editor eingetragen und gespeichert.}
{Der Nutzer betätigt die Parsen-Schaltfläche in der Menüleiste.}
{Das Prolog-Programm wird erfolgreich geparst. Es werden keine Fehlermeldungen ausgegeben. Das Eingabefeld wird freigegeben.}

\teststep{Das formatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} ist im Editor eingetragen, gespeichert und durch den Parser verarbeitet worden.}
...
\teststep{Das unformatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} ist im Editor eingetragen und gespeichert worden. Das Wort \enquote{Fehler(} wurde vor die ursprüngliche erste Zeile eingetragen.}
{Der Nutzer betätigt die Parsen-Schaltfläche in der Menüleiste.}
...
\teststep{Der Nutzer hat ein Prolog-Programm ausgewählt, welches das formatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} enthält.}
...
\teststep{Der Editor enthält das formatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm}.}
{Der Nutzer betätigt die Parsen-Schaltfläche in der Menüleiste.}
{Das Prolog-Programm wird erfolgreich geparst. Es werden keine Fehlermeldungen ausgegeben. Das Eingabefeld wird freigegeben.}
...
\teststep{Der Nutzer hat das Programm nach dem Speichern des \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programms} im Anhang neu gestartet.}
{Der Nutzer wählt das \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} über die Menüleiste unter \enquote{Kürzlich geöffnete Dateien} aus.}
{Das \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} wird im Editor geöffnet.}

\teststep{Der Editor enthält das formatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} analog zum Anhang.}
{Der Nutzer betätigt die Parsen-Schaltfläche in der Menüleiste.}
{Das Prolog-Programm wird erfolgreich geparst. Es werden keine Fehlermeldungen ausgegeben. Das Eingabefeld wird freigegeben.}

\teststep{Das Prolog-Programm wurde erfolgreich geparst. Es wurden keine Fehlermeldungen ausgegeben.}
{Der Nutzer gibt im Eingabefeld \texttt{mother(X, bart).} ein und bestätigt die Eingabe.}
{Der Parser verarbeitet die Abfrage korrekt. Die Interpretation wird gestartet und der erste Interpretationsschritt wird visualisiert.}
...
\teststep{Der Nutzer hat das formatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} aus dem Anhang im Editor eingetragen, durch den Parser verarbeiten lassen und die Abfrage \texttt{mother(X, bart).} gestellt. Der Interpreter ist beim ersten Schritt der Interpretation der gegebenen Abfrage. Eine Visualisierung dieses Schritts wird angezeigt.}
...
\teststep{Die Visualisierung entspricht dem Zustand, bei dem die Lösung \texttt{X = marge} gefunden wurde. Es wurde in die nach links verschobene Visualisierung hineingezoomt. Die Visualisierung wurde bereits als Bild-Datei exportiert.}
...
\teststep{Der Nutzer hat das formatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} im Editor eingetragen.}
...
\teststep{Der Nutzer hat über den Öffnen-Dialog eine Datei ausgewählt, welche das unformatierte \hyperref[appendix:simpsons]{\texttt{simpsons.pl}-Programm} enthält.}
...
\begin{minipage}{\linewidth}
\makebox[\linewidth]{
\includegraphics[width=0.7\linewidth]{build/visualisation/30_unification_success.png}
}
\captionof{figure}{Erfolgreiches Unifikationsziel}
\end{minipage}

\begin{minipage}{\linewidth}
\makebox[\linewidth]{
\includegraphics[width=0.7\linewidth]{build/visualisation/31_unification_fail.png}
}
\captionof{figure}{Fehlgeschlagenes Unifikationsziel}
\end{minipage}
...
\begin{minipage}{\linewidth}
\makebox[\linewidth]{
\includegraphics[width=0.7\linewidth]{build/visualisation/optional_is.png}
}
\captionof{figure}{Erfolgreiche Unifikation und Fehlschlag von \texttt{is}}
\end{minipage}
...
\begin{minipage}{\linewidth}
\makebox[\linewidth]{
\includegraphics[width=\linewidth]{build/visualisation/optional_comparison.png}
}
\captionof{figure}{Mögliche Ergebnisse arithmetischer Vergleiche}
\end{minipage}
...
\begin{minipage}{\linewidth}
\makebox[\linewidth]{
\includegraphics[width=\linewidth]{build/visualisation/optional_cut.png}
}
\captionof{figure}{Ersterfüllung des Cut}
\end{minipage}
...
\begin{minipage}{\linewidth}
\makebox[\linewidth]{
\includegraphics[width=\linewidth]{build/visualisation/optional_cut_backtrack.png}
}
\captionof{figure}{Fehlschlagen der übergeordneten Regel}
\end{minipage}
