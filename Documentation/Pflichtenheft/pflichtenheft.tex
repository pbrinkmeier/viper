...
\textbf{Arithmetik}:
Berechnung mathematischer Operationen (bspw. Summen, Differenzen, Vergleiche etc.).
...
\textbf{Unifikation}
Ersetzen von Variablen durch eine Belegung, die alle Term-Gleichungen erfüllt.
...
\textbf{Rückschreiten / Backtracking}:
