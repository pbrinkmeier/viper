...
Das Programm soll die \enquote{Cut}-Funktionalität unterstützen. Mit dieser kann der Nutzer dem Interpreter durch das hinzufügen eines \enquote{!} als Teilziel verbieten zu einer bestimmten Stelle zurück zu springen.

\criteriumOptional{Arithmetik}{crt:maths}

Das Programm soll grundlegende Arithmetik unterstützen. Da Terme in Prolog nur für sich selber stehen, können Abfragen wie \enquote{4 = 1 + 3} nicht bearbeitet werden. Daher wird der Interpreter um ein Rechenoperator \enquote{is} erweitert welches solche arithmetischen Abfragen ermöglicht.
...
Das Programm beschränkt sich auf eine graphische Darstellung über GUI-Elemente. Eine Interaktion über die Konsole ist nicht unterstützt.
...
Das Prolog-Programm kann im Editor bearbeitet werden. Die Änderungen werden erst bei speichern zurückgeschrieben.
...
Durch Drücken und Halten der linken Maustaste lässt sich der angezeigte Ausschnitt des Graphen bewegen, wodurch in diesen navigiert werden kann.
