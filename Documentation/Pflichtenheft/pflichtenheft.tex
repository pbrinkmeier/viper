...
\criterium{Einzelschritt-Interpreter}
...
\criteriumOptional{Zurückschreiten}
...
\criteriumOptional{Standardbibliothek}
...
\criteriumOptional{Standardbibliothek deaktivieren}

Das Programm soll es dem Nutzer ermöglichen die eingebundene Standardbibliothek deaktivieren zu können.

\criteriumOptional{Export von Visualisierungsbäumen als LaTeX-Code}
...
\criteriumOptional{Syntaxhighlighting}
...
\criteriumOptional{"Pretty-Printing" von Listen}

Das Programm soll Listen bei der Ausgabe einheitlich auf "[x,y,z]" formatieren.

\criteriumOptional{Touch-Bedienung}
