...
\criterium{Erstellen eines Prolog-Programms}{crt:create}

Das Programm soll es dem Nutzer ermöglichen eigene Prolog-Programme in den Editor zu schreiben. Dabei wird der Editor geleert sobald ein neues Prolog-Programm erstellt wird.
...
Das Programm soll Änderungen am momentan geladenen Prolog-Programm speichern können. Wurde die Datei in der Zwischenzeit schon anderweitig verändert, werden diese Änderungen überschrieben.
