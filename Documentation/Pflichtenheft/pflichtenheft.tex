...
Klickt der Nutzer auf \enquote{Parsen}, versucht der Parser das Prolog-Programm im Editor zu verarbeiten.
Stößt er dabei auf Fehler, wird eine Fehlermeldung in der Konsole angezeigt.
Das Eingabefeld bleibt weiterhin deaktiviert.
...
Klickt der Nutzer auf \enquote{Parsen}, versucht der Parser das Prolog-Programm im Editor zu verarbeiten.
Treten dabei keine Fehler auf, wird eine entsprechende Meldung in der Konsole angezeigt.
Das Eingabefeld wird aktiviert; der Nutzer kann jetzt Abfragen eingeben.
...
Gibt der Nutzer eine Abfrage im Eingabefeld ein, versucht der Parser, diese Eingabe zu einem einzelnen Ziel zu verarbeiten.
Stößt er dabei auf Fehler, wird eine Fehlermeldung in der Konsole angezeigt.
