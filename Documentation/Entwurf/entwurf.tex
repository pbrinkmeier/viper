...
Entspricht einer Swing-Komponente für das Anzeigen von SVGs. Ermöglicht ebenfalls die Navigation innerhalb der Komponente.
...
Entspricht einer Swing-Komponente, welche einen Text-Editor darstellt. Neben grundlegenden Funktionen eines Textfelds (Hinzufügen und Löschen von Text, Einfügen aus der Zwischenablage, Markieren von Text) wird automatisches Code-Folding, Suchen und Ersetzen sowie Syntax-Highlighting unterstützt.
...
Datenstruktur für die Konstruktion eines Graphviz-Graphen. Die syntaktische Beschreibung des Graphen orientiert sich an der Graphviz DOT-Sprache, ist jedoch in Java-Syntax umgesetzt.

\subsection{Paket \texttt{guru.nidi.graphviz.engine}}

Beinhaltet Klassen für die Generierung verschiedener Darstellungsformate  aus der internen modellierung eines Graphen.

\subsubsection{Klasse \texttt{Graphviz}}

Entspricht einer Graphviz-Umgebung. Diese kapselt interne Datenstrukturen wie die zu nutzende Engine oder die Maße und Skalierung der Darstellung.
